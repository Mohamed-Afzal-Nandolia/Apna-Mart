  ...
  return (
    <form className="h-screen w-screen flex flex-col justify-center place-items-center" onSubmit={handleSubmit(onSubmit)}>
      <div className="p-10 flex flex-col gap-6 bg-white shadow-sm rounded-xl">
        ...
        <h3 className="text-slate-950 text-sm sm:text-base ">Enter your information to login</h3>
        ...
        <button className="bg-slate-950 shadow-md text-white px-3 py-2 rounded-lg text-base hover:bg-slate-950 ease-in duration-300 hover:scale-105" type="submit">
          {
            isSubmitting ?
            "Loading..." :
            "Submit" 
